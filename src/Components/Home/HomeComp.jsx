      ...
      <div className="hero-area">
        <div className="hero-text">
          <h1>
            Best Platform
            <br />
            Find Your <br /> Perfect <span>JOB</span>{" "}
          </h1>
          <p>
            Discover an array of thrilling career opportunities tailored to your
            interests and academic focus. Your ideal job is on the horizon,
            ready for you to seize.
          </p>
          <div className="btn">
            <div className="btn-b">
              <Link to="/users">
